"""mining_case_james.py - customized BI mining analysis.

A customized example of exploring and mining raw smart sales data.
...
def plot_price_distribution(df_products: pd.DataFrame) -> None:
    ...
    ax.hist(prices.dropna(), bins=15, color="steelblue", edgecolor="white")

    # Set the title for the chart
    # And remind users to close the chart window to continue the workflow
    ax.set_title("Product Price Distribution - 15 Bins(CLOSE chart to continue)")
